...
export default function Tutorial() {
  ...
  const changePage = () => router.push("/play");

  return (
    <section className="grid h-screen place-content-center">
      <Fade toggler={showContent} duration={500} onEnd={changePage}>
        <header className="text-center font-caveat">
          <span className="block text-3xl text-neutral-700">1min</span>
          <h2 className="font-caveat text-5xl text-love">Quick Tutorial</h2>
          <span className="block text-5xl text-rose">how to play:</span>
        </header>
        ...
        <main className="py-10">
          ...
          <div className="mx-auto mt-8 flex items-center justify-center text-sm">
            ...
            >
              <span
                className={clsx(
                  isHideQuickTutorial ? "bg-neutral-700" : "bg-none",
